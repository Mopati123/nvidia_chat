...
try:
    from apps.telegram.telegram_bot_full import TRADING_AVAILABLE
    if TRADING_AVAILABLE:
        print('✅ Trading system imports available in telegram_bot_full.py')
        
        # Check what components are available
        from apps.telegram.telegram_bot_full import trading_system, evidence_emitter
...
try:
    from apps.telegram.telegram_bot_full import (
