...
TEST_CATEGORIES = {
    'Phase 1: Smoke Tests (Fast)': [
        ('preflight_check.py', 30),
        ('test_production_system.py', 60),
    ],
    'Phase 2: Core Feature Tests': [
        ('test_taep_integration.py', 30),
        ('test_riemannian_geometry.py', 30),
        ('test_microstructure_integration.py', 30),
        ('test_nn_integration.py', 30),
        ('test_rl_integration.py', 30),
        ('test_memory_integration.py', 30),
    ],
    'Phase 3: System Integration Tests': [
        ('test_complete_system_e2e.py', 120),
        ('test_full_system.py', 60),
        ('test_integration.py', 30),
        ('test_integration_final.py', 30),
    ],
    'Phase 4: Infrastructure & Broker Tests': [
        ('test_deriv_connection.py', 30),
        ('test_shadow_live.py', 30),
        ('test_multi_agent.py', 30),
    ],
    'Phase 5: Specialized Tests': [
        ('test_superposition.py', 30),
        ('test_strategy_agent.py', 30),
        ('test_acceleration.py', 30),
        ('test_coherence_audit.py', 30),
    ],
}
