...
Usage:
    python -m scripts.broker.verify_brokers
"""
...
def test_setup_credentials_cli():
    ...
    try:
        from scripts.broker import setup_credentials
...
def print_summary(results):
    ...
    print("  2. Run: python -m scripts.broker.setup_credentials add deriv")
    print("  3. Run: python -m scripts.broker.setup_credentials add mt5")
