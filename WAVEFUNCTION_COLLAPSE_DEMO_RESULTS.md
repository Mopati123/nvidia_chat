...
| preflight_check.py | root | Pre-flight verification script |
| start_paper_trading.py | root | Demo startup script |
| generate_demo_report.py | root | Results analysis script |
