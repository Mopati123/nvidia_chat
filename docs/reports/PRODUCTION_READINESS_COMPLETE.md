...
### Test Files (2)
```
validation/legacy/test_production_system.py - 6 phase tests
validation/legacy/test_complete_system_e2e.py - 14 end-to-end tests
```
...
1. **Configure Demo Accounts**
   - Add Deriv API token: `python -m scripts.broker.manage_brokers add deriv`
   - Add MT5 credentials: `python -m scripts.broker.manage_brokers add mt5`
   - Verify connections: `python -m scripts.broker.manage_brokers test deriv` or `python -m scripts.broker.manage_brokers test mt5`
