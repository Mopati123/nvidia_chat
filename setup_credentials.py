...
Usage:
    python setup_credentials.py add deriv
    python setup_credentials.py add mt5
    python setup_credentials.py list
    python setup_credentials.py remove <broker> <name>
    python setup_credentials.py test <broker> <name>
"""
...
def cmd_list(args):
    ...
    if not accounts:
        ...
        print("\nUse 'python setup_credentials.py add <broker>' to add credentials")
        return
...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python setup_credentials.py add deriv      # Add Deriv.com API token
  python setup_credentials.py add mt5       # Add MetaTrader 5 credentials
  python setup_credentials.py list          # Show all stored credentials
  python setup_credentials.py test deriv demo  # Test Deriv connection
  python setup_credentials.py remove mt5 broker1 # Remove MT5 credentials
        """
    )
